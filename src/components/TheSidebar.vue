<template>
	<aside class="sidebar" :class="{ 'open': showDrawer }">
		<GameLogo />
		<p class="tagline">
			Built with <a href="https://vuejs.org/" title="vuejs.org" target="_blank">Vuejs</a>
		</p>
		<button class="toggle" @click="toggleBasicStrategy">
		...
		<div class="footer">
			<p>
				...
				<a href="https:twitter.com/juanjoserp" title="twitter" target="_blank">Juan Rebolledo</a>
			</p>
			<p>
				<a href="https://github.com/rpj-17/blackjack-clone" title="Github project page" target="_blank">Github project page</a>
			</p>
		</div>
	</aside>
</template>
